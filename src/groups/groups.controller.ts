...
export class GroupsController {
	...
	async createGroup(@Body() createGroupDto: CreateGroupDto, @Request() req: any): Promise<Group> {
	...
	async getGroupById(@Param('groupId') groupId: string, @Request() req: any): Promise<Group> {
	...
	async deleteGroup(@Param('groupId') groupId: string, @Request() req: any): Promise<void> {
	...
	async updateMemberRole(
		...
		return this.groupsService.updateMemberRole(groupId, memberId, body.role, req.user.id);
	}
	...
	async leaveGroup(@Param('groupId') groupId: string, @Request() req: any): Promise<void> {
