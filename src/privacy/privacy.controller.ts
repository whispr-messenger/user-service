import { Controller, Get, Patch, Body, Param, ParseUUIDPipe, HttpStatus } from '@nestjs/common';
...
export class PrivacyController {
	...
	async getPrivacySettings(@Param('userId', ParseUUIDPipe) userId: string): Promise<PrivacySettings> {
