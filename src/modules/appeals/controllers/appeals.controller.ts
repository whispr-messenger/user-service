...
export class AppealsController {
	...
	@ApiResponse({ status: HttpStatus.CREATED, description: 'Appeal created' })
	...
	@ApiResponse({ status: HttpStatus.OK, description: 'Queue retrieved' })
	...
	@ApiResponse({ status: HttpStatus.OK, description: 'Appeal detail' })
	@ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Appeal not found' })
	...
	@ApiResponse({ status: HttpStatus.OK, description: 'Appeal reviewed' })
	@ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Admin role required' })
	@ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Appeal not found' })
