...
export class DatabaseConfig implements TypeOrmOptionsFactory {
	...
	createTypeOrmOptions(): TypeOrmModuleOptions {
		const ssl = this.configService.get<string>('DATABASE_SSL', 'false') === 'true';
		...
		return {
			...
			synchronize: this.configService.get<string>('DATABASE_SYNCHRONIZE', 'false') === 'true',
			logging: this.configService.get<string>('DATABASE_LOGGING', 'false') === 'true',
