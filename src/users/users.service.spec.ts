...
describe('UsersService', () => {
	...
	beforeEach(async () => {
		...
		_privacyRepository = module.get<Repository<PrivacySettings>>(getRepositoryToken(PrivacySettings));
	...
	describe('updateUser', () => {
		...
		it('should throw ConflictException if username already exists', async () => {
			...
			await expect(service.update(mockUser.id, updateWithUsername)).rejects.toThrow(ConflictException);
		});
	});
