...
describe('UsersController', () => {
  ...
  describe('updateMyPrivacySettings', () => {
    it('should update current user privacy settings', async () => {
        ...
        mockPrivacyService.updatePrivacySettings.mockResolvedValue({ ...mockPrivacySettings, ...updateDto });
  ...
  describe('update', () => {
    ...
    it('should throw UnauthorizedException if updating another user', async () => {
        ...
        await expect(controller.update('other-id', updateDto, req)).rejects.toThrow(UnauthorizedException);
    });
  });
